/** 
 *  MediaRenderer Player v2.3.0
 *
 *  Author: SmartThings - Joey Brock
 *
 */
...
metadata {
	...
	definition (name: "DLNA Player", namespace: "jybrock", author: "SmartThings-Joey Brock") {
		capability "Actuator"
		capability "Switch"
		capability "Refresh"
		capability "Sensor"
...
/*
  ...
  // Row 1a
	standardTile("nextTrack", "device.btnMode", width: 1, height: 1, decoration: "flat") {
        ...
        state "station", label:'Next Station', action:"nextStation", icon:"", backgroundColor:"#ffffff",nextState:"station"
        state "genre", label:'Next Genre', action:"nextGenre", icon:"", backgroundColor:"#ffffff",nextState:"genre"
	}
	standardTile("play", "device.btnMode", width: 1, height: 1, decoration: "flat") {
        ...
        state "station", label:'Play Station', action:"playStation", icon:"", nextState:"station", backgroundColor:"#ffffff"
        state "genre", label:'Play Station', action:"playStation", icon:"", nextState:"genre", backgroundColor:"#ffffff"
	}
	standardTile("previousTrack", "device.btnMode", width: 1, height: 1, decoration: "flat") {
        ...
        state "station", label:'Prev Station', action:"previousStation", icon:"", backgroundColor:"#ffffff",nextState:"station"
        state "genre", label:'Prev Genre', action:"previousGenre", icon:"", backgroundColor:"#ffffff",nextState:"genre"
	}
